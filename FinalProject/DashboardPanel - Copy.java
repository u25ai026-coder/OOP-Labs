...
public class DashboardPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        // ---- MOTORCYCLE SLOTS ----
        content.add(makeSectionLabel("Motorcycle Slots  (M1 – M20)"));
        content.add(Box.createRigidArea(new Dimension(0, 6)));
        motoGrid = new JPanel(new FlowLayout(FlowLayout.LEFT, 6, 6));
        ...
        // ---- CAR SLOTS ----
        content.add(makeSectionLabel("Car Slots  (C1 – C10)"));
        content.add(Box.createRigidArea(new Dimension(0, 6)));
        carGrid = new JPanel(new FlowLayout(FlowLayout.LEFT, 6, 6));
        ...
        content.add(Box.createRigidArea(new Dimension(0, 6)));
        truckGrid = new JPanel(new FlowLayout(FlowLayout.LEFT, 6, 6));
